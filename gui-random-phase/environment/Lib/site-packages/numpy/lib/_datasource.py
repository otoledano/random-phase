...
class Repository (DataSource):
    ...
    A data model where multiple DataSource's share a base
    URL/directory.
    ...
    Examples
    --------
    To analyze all files in the model, do something like this
    ...
    Similarly you could use a URL for a model::
