...
LEXERS = {
    ...
    'CssDjangoLexer': ('pip._vendor.pygments.lexers.template', 'CSS+Django/Jinja', ('css+django', 'css+jinja'), (), ('text/css+django', 'text/css+jinja')),
    ...
    'HtmlDjangoLexer': ('pip._vendor.pygments.lexers.template', 'HTML+Django/Jinja', ('html+django', 'html+jinja', 'htmldjango'), (), ('text/html+django', 'text/html+jinja')),
    ...
    'IniLexer': ('pip._vendor.pygments.lexers.configs', 'INI', ('ini', 'cfg', 'dosini'), ('*.ini', '*.cfg', '*.inf', '.editorconfig', '*.view', '*.socket', '*.device', '*.mount', '*.automount', '*.swap', '*.target', '*.path', '*.timer', '*.slice', '*.scope'), ('text/x-ini', 'text/inf')),
    ...
    'JavascriptDjangoLexer': ('pip._vendor.pygments.lexers.template', 'JavaScript+Django/Jinja', ('javascript+django', 'js+django', 'javascript+jinja', 'js+jinja'), (), ('application/x-javascript+django', 'application/x-javascript+jinja', 'text/x-javascript+django', 'text/x-javascript+jinja', 'text/javascript+django', 'text/javascript+jinja')),
    ...
    'XmlDjangoLexer': ('pip._vendor.pygments.lexers.template', 'XML+Django/Jinja', ('xml+django', 'xml+jinja'), (), ('application/xml+django', 'application/xml+jinja')),
    ...
    'YamlJinjaLexer': ('pip._vendor.pygments.lexers.template', 'YAML+Jinja', ('yaml+jinja', 'salt', 'sls'), ('*.sls',), ('text/x-yaml+jinja', 'text/x-sls')),
...
if __name__ == '__main__':  # pragma: no cover
    ...
    with open(__file__) as fp:
        ...
        # model, for example by using some kind of automatic
