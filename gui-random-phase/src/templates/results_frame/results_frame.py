...
from src.templates.results_frame.results_max_content import ResultsMaxContent
from src.templates.results_frame.results_standard_content import ResultsStandardContent
...
class ResultsFrame(ttk.Frame):
    ...
    def paint(self) -> None:
        ...
        self.label_panel_title.config(text="Results", anchor="center")
        ...
        self.panel_standard_content = ResultsStandardContent(self, self.service)
        self.panel_standard_content.grid(Cts.GRID_1_0)

        self.panel_maximized_content = ResultsMaxContent(self, self.service)
